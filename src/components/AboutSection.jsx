import { GraduationCap, Code, Brain, Globe, BarChart3 } from 'lucide-react';
...
const AboutSection = () => {
  const highlights = [
    ...
    },
    {
      ...
      title: "Data Analyst",
      description: "Skilled in data exploration, visualization, and transforming data into actionable insights"
    },
    {
    ...
    },
    {
      ...
      description: "Multilingual with Telugu, and English proficiency"
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed">
                Throughout my academic journey, I've maintained a strong CGPA of 8.22 while
                actively participating in internships and projects that have enhanced my
                practical skills in AI, Machine Learning, and Data Analysis.
              </p>
              <p className="text-gray-700 leading-relaxed">
                My interests extend beyond academics to exploring advanced data analytics techniques, reading data science blogs, and working on real-world datasets. I am passionate about extracting insights from data and continuously improving my analytical skills to solve real-world business problems.
              </p>
            </div>
